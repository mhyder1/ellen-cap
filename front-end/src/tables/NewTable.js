    ...
    return (
        <>
            ...
            <div className="mb-3">
                    ...
                    <input placeholder="Table Name" type="text" className="form-control" id="table_name" name="table_name" value={tableName} onChange={handleTableNameChange} />
                </div>
                <div className="mb-3">
                    <label for="capacity" className="form-label">Capacity</label>
                    <input placeholder="Capacity" type="text" className="form-control" id="capacity" name="capacity" value={capacity} onChange={handleCapacityChange} />
                </div>
                <div>
                    <button 
                    type="button"
